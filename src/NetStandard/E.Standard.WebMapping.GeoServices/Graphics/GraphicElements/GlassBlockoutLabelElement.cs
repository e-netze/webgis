...
public class GlassBlockoutLabelElement : IGraphicElement
{
    ...
    public GlassBlockoutLabelElement(Point point, string text, ArgbColor color, ArgbColor bkcolor, string fontName, float size, Offset offset)
    {
        _point = point;
        _color = color;
        _bkcolor = bkcolor;
