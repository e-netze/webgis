...
(function ($) {
    ...
    var initUI = function (elem, options) {
        ...
        var $input = $("<input style='position:absolute;left:" + left + "px;background-color:var(--ui-surface);width:100%;max-width:" + (320 - (left + 35)) + "px;right:" + (options.detail_search == false ? "36px" : "71px") + "' class='webgis-search-input' type='text' placeholder='Schnellsuche...' />").appendTo($elem)
