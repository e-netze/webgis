...
- **ESC**:
  Bearbeitung abbrechen. Das aktuelle Werkzeug (z.B. Insert/Update/Delete Maske) wird geschlossen. Wurden in der Maske Änderungen vorgenommen, muss das Abbrechen mit **Änderungen verwerfen** bestätigt werden.
