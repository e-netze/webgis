...
Gibt an, ob das Feld in der Suchmaske angezeigt wird. Nicht sichbare Felder sind beispielsweise sinnvoll, wenn diese nur für parametrierte Aufrufe verwendet werden sollten, für den Anwender aber nicht sichtbar sein sollten (z.B. Adresscode, ObjectID, ...).
...
Dieser Text wird unter dem Eingabefeld angegzeigt und soll dem Anwender Beispielwerte für die Eingabe vermitteln.
...
Mit dieser Expression wird die Eingabe formatiert. {0} ist der Platzhalter für die Usereingabe, zB DATE '{0}' => wird zu DATE '2015-5-3'. Achtung: Wenn eine Expression angeben wird, muss der komplette Ausdruck angegeben inklusive (einfachen) Hochkomma am Anfang oder Ende angeben werden! zB 'fix_prefix_{0}_fix_postfix'.
...
Hier kann ein String mit Zeichen angegeben werden, die von der SQL-Injektion überprüfung ignoriert werden. zB: ><&'\"
...
Um bei Oracle Datenbanken nicht Case-Sensitiv zu suchen, kann für String Felder SQL-Upper auf 'true' gesetzt werden. Liegt eine SQL Server Datenbank zugrunde, ist der Wert immer auf 'false' zu setzen.
