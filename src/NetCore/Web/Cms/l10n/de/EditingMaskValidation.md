...
Wert auf den geprüft wird. Hier kann auch auf eine Liste mit Trennzeichen (, oder ;) angegeben werden. Außerdem sind Platzhalter für User-Rollen möglich: role-parameter:GEMNR
